...
- 🏢 I met the subject requirements of the university, currently looking for an internship
  
- 📂 Always open to projects that push my skills forward and help me grow as a developer

- 🎨 Passionate about creativity and building cohesive brand identities from concept to execution
...
### Some of my projects
| Project | Preview | Description | Tech | Link |
|---------|---------|-------------|------|------|
| **Kápolna Pince Borozó** | <img src="https://s6.imgcdn.dev/Y8w402.png" width="500" /> | A pub  website featuring a billiard table booking system. | Nuxt.js, ASP.NET Core, PostgreSQL | [kapolnapinceborozo.hu](https://kapolnapinceborozo.hu) |
| **Codelingo** | <img src="https://s6.imgcdn.dev/Y8wu48.png" width="500" /> | Duolingo-inspired programming learning platform. Contributed as frontend developer & brand designer | ASP.NET Core, Angular, MSSQL | [View Repo](https://github.com/bprof-spec-codes/codelingo) |
| **DepotMap** | <img src="https://s6.imgcdn.dev/Y8wMFy.png" width="500" /> | Warehouse management system from procurement to outgoing orders with visual warehouse layout | ASP.NET Core, Angular, MSSQL | [View Repo](https://github.com/bprof-spec-codes/depotmap) |
 ---
